...
# monomind:start skills:opencode:mastermind-execute
# Mastermind Execute
...
- `Skill("mastermind-finish")` — complete the development branch after all tasks
- `Skill("mastermind-verify")` — verification gate before finishing
# monomind:end skills:opencode:mastermind-execute
# monomind:start skills:kimi:mastermind-execute
# Mastermind Execute
...
- `Skill("mastermind-finish")` — complete the development branch after all tasks
- `Skill("mastermind-verify")` — verification gate before finishing
# monomind:end skills:kimi:mastermind-execute
# monomind:start skills:codex:mastermind-execute
# Mastermind Execute
...
- `Skill("mastermind-finish")` — complete the development branch after all tasks
- `Skill("mastermind-verify")` — verification gate before finishing
# monomind:end skills:codex:mastermind-execute
