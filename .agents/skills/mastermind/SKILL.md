...
# monomind:start skills:opencode:mastermind
# Mastermind
...
If skills cannot be loaded natively, run `monomind mastermind run <skill> --print`.
# monomind:end skills:opencode:mastermind
# monomind:start skills:kimi:mastermind
# Mastermind
...
# monomind:start skills:codex:mastermind
# Mastermind
...
If skills cannot be loaded natively, run `monomind mastermind run <skill> --print`.
# monomind:end skills:codex:mastermind
