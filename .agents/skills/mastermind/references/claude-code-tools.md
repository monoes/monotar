...
# monomind:start skills:opencode:mastermind:references/claude-code-tools.md
# Claude Code Tool Mapping
...
User-level skills live at **`~/.claude/skills/`**. Each skill is a subdirectory containing a `SKILL.md` (with `name` and `description` frontmatter) plus any supporting files. Claude Code does not currently recognize the cross-runtime `~/.agents/skills/` path that Codex, Copilot CLI, and Gemini CLI read; if you're relying on cross-runtime support in the future, verify against the official skills docs.
# monomind:end skills:opencode:mastermind:references/claude-code-tools.md
# monomind:start skills:kimi:mastermind:references/claude-code-tools.md
# Claude Code Tool Mapping
...
User-level skills live at **`~/.claude/skills/`**. Each skill is a subdirectory containing a `SKILL.md` (with `name` and `description` frontmatter) plus any supporting files. Claude Code does not currently recognize the cross-runtime `~/.agents/skills/` path that Codex, Copilot CLI, and Gemini CLI read; if you're relying on cross-runtime support in the future, verify against the official skills docs.
# monomind:end skills:kimi:mastermind:references/claude-code-tools.md
# monomind:start skills:codex:mastermind:references/claude-code-tools.md
# Claude Code Tool Mapping
...
User-level skills live at **`~/.claude/skills/`**. Each skill is a subdirectory containing a `SKILL.md` (with `name` and `description` frontmatter) plus any supporting files. Claude Code does not currently recognize the cross-runtime `~/.agents/skills/` path that Codex, Copilot CLI, and Gemini CLI read; if you're relying on cross-runtime support in the future, verify against the official skills docs.
# monomind:end skills:codex:mastermind:references/claude-code-tools.md
