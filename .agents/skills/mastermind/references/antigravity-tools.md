...
# monomind:start skills:opencode:mastermind:references/antigravity-tools.md
# Antigravity CLI (`agy`) Tool Mapping
...
At the start of any multi-step task, create the task artifact listing every step of your plan. As you complete each step, edit the artifact to mark it done (`- [x]`). If the plan changes, update the checklist. Keep it current — it is your source of truth for what remains; once the conversation gets long, re-read it before starting each step.
# monomind:end skills:opencode:mastermind:references/antigravity-tools.md
# monomind:start skills:kimi:mastermind:references/antigravity-tools.md
# Antigravity CLI (`agy`) Tool Mapping
...
At the start of any multi-step task, create the task artifact listing every step of your plan. As you complete each step, edit the artifact to mark it done (`- [x]`). If the plan changes, update the checklist. Keep it current — it is your source of truth for what remains; once the conversation gets long, re-read it before starting each step.
# monomind:end skills:kimi:mastermind:references/antigravity-tools.md
# monomind:start skills:codex:mastermind:references/antigravity-tools.md
# Antigravity CLI (`agy`) Tool Mapping
...
At the start of any multi-step task, create the task artifact listing every step of your plan. As you complete each step, edit the artifact to mark it done (`- [x]`). If the plan changes, update the checklist. Keep it current — it is your source of truth for what remains; once the conversation gets long, re-read it before starting each step.
# monomind:end skills:codex:mastermind:references/antigravity-tools.md
