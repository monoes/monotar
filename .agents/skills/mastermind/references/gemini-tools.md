...
# monomind:start skills:opencode:mastermind:references/gemini-tools.md
# Gemini CLI Tool Mapping
...
| `tracker_create_task`, `tracker_update_task`, `tracker_get_task`, `tracker_list_tasks`, `tracker_add_dependency`, `tracker_visualize` | Rich task tracker with dependency and visualization support |
| `read_mcp_resource`, `list_mcp_resources` | MCP resource access |
# monomind:end skills:opencode:mastermind:references/gemini-tools.md
# monomind:start skills:kimi:mastermind:references/gemini-tools.md
# Gemini CLI Tool Mapping
...
| `tracker_create_task`, `tracker_update_task`, `tracker_get_task`, `tracker_list_tasks`, `tracker_add_dependency`, `tracker_visualize` | Rich task tracker with dependency and visualization support |
| `read_mcp_resource`, `list_mcp_resources` | MCP resource access |
# monomind:end skills:kimi:mastermind:references/gemini-tools.md
# monomind:start skills:codex:mastermind:references/gemini-tools.md
# Gemini CLI Tool Mapping
...
| `tracker_create_task`, `tracker_update_task`, `tracker_get_task`, `tracker_list_tasks`, `tracker_add_dependency`, `tracker_visualize` | Rich task tracker with dependency and visualization support |
| `read_mcp_resource`, `list_mcp_resources` | MCP resource access |
# monomind:end skills:codex:mastermind:references/gemini-tools.md
