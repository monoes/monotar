...
# monomind:start skills:opencode:mastermind:references/codex-tools.md
# Codex Tool Mapping
...
The agent can still run tests, stage files, and output suggested branch names, commit messages, and PR descriptions for the user to copy.
# monomind:end skills:opencode:mastermind:references/codex-tools.md
# monomind:start skills:kimi:mastermind:references/codex-tools.md
# Codex Tool Mapping
...
The agent can still run tests, stage files, and output suggested branch names, commit messages, and PR descriptions for the user to copy.
# monomind:end skills:kimi:mastermind:references/codex-tools.md
# monomind:start skills:codex:mastermind:references/codex-tools.md
# Codex Tool Mapping
...
The agent can still run tests, stage files, and output suggested branch names, commit messages, and PR descriptions for the user to copy.
# monomind:end skills:codex:mastermind:references/codex-tools.md
