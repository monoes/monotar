...
# monomind:start skills:opencode:mastermind-plan
# Mastermind Plan
...
- Invoke `Skill("mastermind-execute")`
- Batch execution with checkpoints for review
# monomind:end skills:opencode:mastermind-plan
# monomind:start skills:kimi:mastermind-plan
# Mastermind Plan
...
- Invoke `Skill("mastermind-execute")`
- Batch execution with checkpoints for review
# monomind:end skills:kimi:mastermind-plan
# monomind:start skills:codex:mastermind-plan
# Mastermind Plan
...
- Invoke `Skill("mastermind-execute")`
- Batch execution with checkpoints for review
# monomind:end skills:codex:mastermind-plan
