...
# monomind:start skills:opencode:mastermind-memory
# Mastermind Memory
...
If `caller` is not "command", follow mastermind-protocol/SKILL.md Brain Write Procedure for domain `ops`.
# monomind:end skills:opencode:mastermind-memory
# monomind:start skills:kimi:mastermind-memory
# Mastermind Memory
...
If `caller` is not "command", follow mastermind-protocol/SKILL.md Brain Write Procedure for domain `ops`.
# monomind:end skills:kimi:mastermind-memory
# monomind:start skills:codex:mastermind-memory
# Mastermind Memory
...
If `caller` is not "command", follow mastermind-protocol/SKILL.md Brain Write Procedure for domain `ops`.
# monomind:end skills:codex:mastermind-memory
