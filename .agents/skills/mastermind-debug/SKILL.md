...
# monomind:start skills:opencode:mastermind-debug
# mastermind:debug — Systematic Debugging
...
- First-time fix rate: ~95% vs ~40%
- New bugs introduced by the fix: near zero vs common
# monomind:end skills:opencode:mastermind-debug
# monomind:start skills:kimi:mastermind-debug
# mastermind:debug — Systematic Debugging
...
- First-time fix rate: ~95% vs ~40%
- New bugs introduced by the fix: near zero vs common
# monomind:end skills:kimi:mastermind-debug
# monomind:start skills:codex:mastermind-debug
# mastermind:debug — Systematic Debugging
...
- First-time fix rate: ~95% vs ~40%
- New bugs introduced by the fix: near zero vs common
# monomind:end skills:codex:mastermind-debug
