...
import {Aggregatorv1Interface} from "@chainlink/contracts/src/v0.8/interfaces/Aggregatorv1Interface.sol";

contract SecureLending {
    Aggregatorv1Interface immutable priceFeed;
...
- How oracle manipulation manifests differently across Uniswap V2 (spot), v1 (TWAP), and Chainlink (staleness)
